...
this.handlePricipalChange = this.handlePricipalChange.bind(this)
this.handleRateChange = this.handleRateChange.bind(this)
this.handleYearChange = this.handleYearChange.bind(this)
this.calculate = this.calculate.bind(this);
};
handlePricipalChange = (e) => {
...
$ <input onChange={ this.handlePricipalChange } value={ this.state.principal }></input><br/><br/>
<label>
Interest Rate
</label><br/>
